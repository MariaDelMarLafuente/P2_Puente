...
class Monitor():
    ...
    def canEnter_carsN(self):
        return (self.npedestrians.value == 0 and self.ncars_1.value == 0)
  
    def canEnter_carsS(self):
        return (self.npedestrians.value == 0 and self.ncars_0.value == 0)
    
    def canEnter_ped(self):
        return (self.ncars_1.value == 0 and self.ncars_0.value == 0)
